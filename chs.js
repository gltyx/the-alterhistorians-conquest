...
var cnItems = {
    ...
    "PRODUCTION": "生产",
    "PRODUCTION (": "生产 (",
    "One of the basic elements. Produced by collection by the river.": "基本元素之一。 由河边采集而成。",
    "Somewhat damp earth. Maybe we can take away the dampness.": "泥土有些潮湿。 也许我们可以去除湿气。",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Consumes (.+) Water\/s$/, '消耗 $1 水\/秒'],
    [/^Consumes (.+) Clay\/s$/, '消耗 $1 黏土\/秒'],
